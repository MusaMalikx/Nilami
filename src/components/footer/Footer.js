        ...
        <div>
            ...
            <div className="container-xxl my-8">
                <div className="flex flex-col lg:flex-row justify-between">
                    <div className="space-y-3 py-3">
                        <h1 className="uppercase h5 font-semibold tracking-widest">Nilami.</h1>
                        <p className="text-xs text-muted tracking-widest">The next-generation auction app for you to start biding your items today! </p>
            ...
            <div className="bg-[#343a40] text-center text-white py-7">
                <div className="container-xxl text-xs text-center tracking-widest">
                    <p>© 2022, Nilami. All rights reserved.</p>
                </div>
            </div>
        </div>
    )
